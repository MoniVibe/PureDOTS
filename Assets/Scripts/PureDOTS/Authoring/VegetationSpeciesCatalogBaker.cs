...
namespace PureDOTS.Authoring
{
    ...
    /// <summary>
    /// Baker that converts a VegetationSpeciesCatalog to a blob-backed singleton.
    /// </summary>
    public sealed class VegetationSpeciesCatalogBaker : Baker<VegetationSpeciesCatalogAuthoring>
    {
