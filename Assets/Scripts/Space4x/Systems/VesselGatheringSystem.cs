        ...
        public void OnUpdate(ref SystemState state)
        {
                         ...
                         .WithEntityAccess())
            {
                ...
                if (aiState.ValueRO.CurrentState != VesselAIState.State.Mining ||
                    ...
                    vessel.ValueRO.Load >= vessel.ValueRO.Capacity * 0.95f)
                {
                    continue;
                }
                ...
                var capacityRemaining = vessel.ValueRO.Capacity - vessel.ValueRO.Load;
                ...
                if (vesselValue.Load >= vesselValue.Capacity * 0.95f)
                {
