...
- [Concepts/Core/Entity_Anatomy_And_Status.md](Concepts/Core/Entity_Anatomy_And_Status.md) – **anatomy + status + memory** scaffolding (limbs/organs, buffs, cognitive facts)
