...
- **Colony Support**: A colony’s development level dictates how many facilities of each tier it can host. Richer planets escalate development faster, but planetary modifiers (gravity, atmosphere, hostility) reduce tier caps or throughput.
