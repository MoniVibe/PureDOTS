...
{
    /// <summary>
    /// Debug HUD for demo that displays entity counts and resource values.
    /// Reads ECS data directly from World.DefaultGameObjectInjectionWorld.
    /// </summary>
    public class DemoDebugHUD : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            // Demo scenario state (already have scenario from above)
