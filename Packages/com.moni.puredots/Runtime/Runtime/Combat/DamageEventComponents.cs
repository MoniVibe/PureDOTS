...
{
    /// <summary>
    /// Impact event - read-only burst component generated by collision/overlap detection.
    /// Stage 1 of 3-stage damage pipeline: ImpactEvent → DamageAccumulator → DamageResolutionSystem.
    /// </summary>
    public struct ImpactEvent : IBufferElementData
    {
        public Entity Target; // Target entity
        public float Damage; // Base damage amount
        public float3 HitPoint; // World-space hit position
    }
